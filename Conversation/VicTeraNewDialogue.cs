        ...
        LocalDB.DumpStoryToLocalLocale("en", "TeraTheTaxCollector", new Dictionary<string, DialogueMachine>(){
            ...
            {"Vic_Tera_Meet_0", new(){
                ...
                dialogue = [
                    ...
                    new(AmTera, "scared", "Y-You were going through my things?"),
                    ...
                    new(AmTera, "S-sorry. I'll get to that."),
                    new(AmVic, "neutraltalk", "Thank you.", flipped: true),
                    new(AmVic, "neutraltalk", "Now please leave. Civilians shouldn't be in the cockpit.", flipped: true),
                    new(AmVic, "observe", "Especially not when there's a hostile ship nearby powering up its weapons.", flipped: true),
                    new(AmTera, "scared", "Huh? W-wait!"),
                    new(AmTera, "scared", "I came to help fight!"),
                    new(AmVic, "determined", "Help how?", flipped: true),
                    new(AmTera, "lookaway", "Well..."),
                    new(AmTera, "I can tax ships to death."),
                    new(AmVic, "pressuredneutral", "What?", flipped: true),
                ]
            }},
